...
module.exports.search = (request, where, orderBy, start, limit, callback) => {
    return tableHelpers.search('campaigns', request,
        ['id', 'cid', 'name', 'list', 'status', 'scheduled', 'delivered', 'blacklisted', 'opened', 'clicks', 'unsubscribed', 'bounced', 'complained', 'created'],
